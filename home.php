...
<head>
    ...
    <style>
        ...
        .navbar {
            ...
            top: 0;
            width: 100%;
            z-index: 1000; /* Agar navbar berada di atas elemen lainnya */
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        Hello, <span id="username"><?php echo htmlspecialchars($_SESSION['user']); ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        <li><a class="dropdown-item" href="#">Data Voucher</a></li>
    ...
    <h2>Our Features</h2>
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card" style="width: 100%;">
                    <img src="/img/high-speed.jpg" class="card-img-top" alt="Secure Connection">
                    <div class="card-body">
